...
Confirmed user preferences that help future agents understand the user's taste, craft standards, and common feedback patterns.

Keep this short. Use one-line bullets. Record only confirmed preferences, not agent inferences, one-off task details, or instructions already captured elsewhere.
